...
export default function HeroSection() {
  return (
    <div className="flex items-center md:mt-20 md:mb-28">
      <div className="w-full lg:w-[65%] hidden md:block">
        <LampContainer>
          <motion.div
            ...
            className="bg-gradient-to-br from-slate-500 dark:from-slate-300 to-slate-800 dark:to-slate-500 text-center lg:text-left bg-clip-text text-5xl font-medium tracking-tight text-transparent"
          >
      ...
      <div className="my-28 md:hidden bg-gradient-to-br from-slate-500 dark:from-slate-300 to-slate-800 dark:to-slate-500 bg-clip-text text-5xl font-medium tracking-tight text-transparent">
