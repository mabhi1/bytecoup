...
export default function ContactUs() {
  return (
    <MotionDiv direction="btot" className="py-10 md:py-16">
      ...
      <div className="text-lg md:text-xl md:font-light mt-8">We&apos;re here to help!</div>
      <p className="mt-3">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2">
        <div>
          ...
          <div className="text-lg md:text-xl md:font-light mt-8">Business Hours:</div>
      ...
      <div className="bg-gradient-to-r from-transparent via-neutral-700 to-transparent my-8 h-[1px] w-full" />
      <div className="text-lg md:text-xl md:font-light mt-8">Partnerships and Collaborations</div>
      <p className="mt-3">
      ...
      <div className="bg-gradient-to-r from-transparent via-neutral-700 to-transparent my-8 h-[1px] w-full" />
      <div className="text-lg md:text-xl md:font-light mt-8">Careers</div>
      <p className="mt-3">
