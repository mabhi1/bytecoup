...
export default function ContactUs() {
  return (
    <div className="py-16">
      <div className="text-3xl font-light uppercase">Contact Us</div>
      ...
      <div className="mt-8 grid grid-cols-2">
        <div>
          ...
          <p className="text-neutral-300 mt-3 flex gap-2 items-center">
          ...
          <p className="text-neutral-300 mt-3 flex gap-2 flex-col">
